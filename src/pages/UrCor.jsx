...
const UrCor = () => (
    <div style={{ padding: '40px 40px 60px 40px', width: '100%', minHeight: 'calc(100vh - 52px - 60px)' }}>
        ...
        <div style={{ fontSize: 30, marginBottom: 24, lineHeight: 1.7 }}>
        ...
        <div style={{ background: '#f7fafd', borderRadius: 12, boxShadow: '0 2px 8px #e0e7ef', padding: 24 }}>
            ...
            <p style={{ fontSize: 30, marginBottom: 16 }}>
            ...
            <ul style={{ fontSize: 25, marginBottom: 16, paddingLeft: 24 }}>
